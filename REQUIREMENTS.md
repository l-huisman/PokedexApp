# Pokedex App Requirements

Assignment from [Inholland React Native Course 3](https://github.com/levizimmerman/inholland-react-native-course-3)

## Deadline
**January 18th before 23:59**

## Grading
- **Base Grade (5.5):** Complete all required items
- **Optional Items:** Each worth +1 point (max 8 points total)
- **Battle Feature:** Worth 100 bonus points
...
3. Include this checklist in README.md with completion status
